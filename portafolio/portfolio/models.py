...
'''
class Project(models.Model):    # Todos los campos son obligatorios si no se define lo contrario
    title = models.CharField(max_length=150, verbose_name='Título')
    description = models.TextField(verbose_name='Descripción')
    image = models.ImageField(upload_to='projects', verbose_name='Imagen')
    link = models.URLField(max_length=180, blank=True, null=True, verbose_name='Enlace') # campo no obligatorio, puede ser nulo
